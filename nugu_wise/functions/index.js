...
exports.nugu_todaywise = (req, res) => {
  ...
  function wise_intent() {
    ...
    console.log("nugu.say(): "+ JSON.stringify(output))
    nugu.say(output);
  }
  ...
  function test_intent() {
    const number1 = nugu.get('number');
    const text1 = nugu.get('text');
    const arr = nugu.getAll();
    output.numbersay = number1 + text1 + arr;
    nugu.say(output);
  }
  ...
  console.log("nugu.getAll(): "+ JSON.stringify(nugu.getAll()))
